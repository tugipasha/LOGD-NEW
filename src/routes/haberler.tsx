...
export const Route = createFileRoute("/haberler")({
  head: () => ({
    meta: [
      { title: "Haberler | LOGD - Liseli Oyun Geliştiriciler Derneği" },
      {
        name: "description",
        content:
...
const NEWS_DATA: NewsArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Programa katılmak isteyen tüm dernek üyelerimiz başvurularını sosyal medya duyurularımız veya iletişim sayfamız üzerinden iletebilirler.",
    ],
  },
  {
