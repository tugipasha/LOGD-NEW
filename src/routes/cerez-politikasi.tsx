...
export const Route = createFileRoute("/cerez-politikasi")({
  head: () => ({
    meta: [
      { title: "Çerez Politikası | LOGD - Liseli Oyun Geliştiriciler Derneği" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Çerez Politikası | LOGD" },
      {
        ...
        content:
          "Liseli Oyun Geliştiriciler Derneği web sitesinde kullanılan çerezler, saklama süreleri ve tercihlerinizi kontrol etme yöntemleri.",
      },
...
function CerezPolitikasiPage() {
  return (
    <LegalLayout
      ...
      subtitle="Liseli Oyun Geliştiriciler Derneği (“LOGD”) olarak web sitemizden en verimli şekilde yararlanabilmeniz ve kullanıcı deneyiminizi geliştirmek için çerezler (cookies) kullanıyoruz."
