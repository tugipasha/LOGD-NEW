...
const PARTNERS = ["Unity", "Unreal Engine", "Blender", "GitHub", "Microsoft", "itch.io"];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="border-y border-border bg-cream">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-between gap-8 px-6 py-8">
          <p className="text-sm font-semibold text-navy">Birlikte üretiyoruz.</p>
          <div className="flex flex-wrap items-center gap-x-10 gap-y-4">
            {PARTNERS.map((p) => (
              <span
                key={p}
                className="flex items-center gap-2 text-base font-bold tracking-tight text-navy/85"
              >
