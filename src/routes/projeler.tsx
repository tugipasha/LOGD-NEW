...
export const Route = createFileRoute("/projeler")({
  head: () => ({
    meta: [
      { title: "Projeler & Oyunlar Showcase | LOGD - Liseli Oyun Geliştiriciler Derneği" },
      {
        name: "description",
        content:
          "Liseli Oyun Geliştiriciler Derneği (LOGD) topluluğunun geliştirdiği oyunları keşfedin. Game Jam, yarışma ve öğrenci projeleri.",
      },
          ...
          >
            ...
            <div className="mt-4 space-y-3 text-xs leading-relaxed text-muted-foreground sm:text-sm">
              <div className="flex items-start gap-2.5">
                ...
                <span>LOGD topluluğumuza katıl ve lise öğrenci/kulüp rolünü doğrula.</span>
              </div>
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-navy text-[11px] font-bold text-cream">
                  2
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span>
                  <strong>İletişim sayfamızdaki</strong> formu doldur. Ekibimiz inceledikten
                  sonra oyunun showcase vitrinine eklenir!
                </span>
              </div>
            </div>
