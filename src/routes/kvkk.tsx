...
export const Route = createFileRoute("/kvkk")({
  head: () => ({
    meta: [
      { title: "KVKK Aydınlatma Metni | LOGD - Liseli Oyun Geliştiriciler Derneği" },
      {
        name: "description",
        content:
          "6698 Sayılı Kişisel Verilerin Korunması Kanunu (KVKK) uyarınca Liseli Oyun Geliştiriciler Derneği (LOGD) Aydınlatma Metni ve Veri Sahibi Hakları.",
      },
...
function KvkkPage() {
  return (
    <LegalLayout
      ...
      subtitle="6698 Sayılı Kişisel Verilerin Korunması Kanunu (“KVKK”) uyarınca, veri sorumlusu sıfatıyla Liseli Oyun Geliştiriciler Derneği (“LOGD”) olarak kişisel verilerinizi kanuna uygun şekilde koruyor ve işliyoruz."
      ...
      <div className="space-y-12 leading-relaxed text-foreground/90">
        ...
        <section id="veri-sorumlusu" className="scroll-mt-28 space-y-4">
          ...
          <p className="text-sm text-muted-foreground sm:text-base">
            ...
            <strong>Liseli Oyun Geliştiriciler Derneği (“LOGD”)</strong> tarafından aşağıda
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <div>
                ...
                <span className="text-muted-foreground">
                  Liseli Oyun Geliştiriciler Derneği (LOGD)
                </span>
              </div>
              <div>
        ...
        <section id="isleme-amaclari" className="scroll-mt-28 space-y-4">
          ...
          <ul className="list-inside list-disc space-y-2 text-sm text-muted-foreground sm:text-base">
            ...
            <li>
              Takım kurma, mentor-öğrenci eşleştirmesi ve topluluk rollerinin atanması,
            </li>
