...
export const Route = createFileRoute("/gizlilik-politikasi")({
  head: () => ({
    meta: [
      { title: "Gizlilik Politikası | LOGD - Liseli Oyun Geliştiriciler Derneği" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Gizlilik Politikası | LOGD" },
      {
        ...
        content:
          "Liseli Oyun Geliştiriciler Derneği (LOGD) gizlilik ilkeleri, veri güvenliği standartları ve kullanıcı hakları.",
      },
...
function GizlilikPolitikasiPage() {
  return (
    <LegalLayout
      ...
      subtitle="Liseli Oyun Geliştiriciler Derneği (LOGD) olarak topluluk üyelerimizin, lise öğrencilerimizin ve tüm ziyaretçilerimizin dijital gizliliğini ve veri güvenliğini en yüksek öncelikle koruyoruz."
      ...
      <div className="space-y-12 leading-relaxed text-foreground/90">
        ...
        <section id="genel-bakis" className="scroll-mt-28 space-y-4">
          ...
          <p className="text-sm text-muted-foreground sm:text-base">
            Bu Gizlilik Politikası; <strong>Liseli Oyun Geliştiriciler Derneği (“LOGD”)</strong>{" "}
        ...
        <section id="kullanim-amaclari" className="scroll-mt-28 space-y-4">
          ...
          <div className="space-y-2.5">
            {[
              ...
              "Üyelik kayıtlarının onaylanması, üye kartı/sertifika hazırlanması ve topluluk iletişim kanallarına erişim verilmesi.",
